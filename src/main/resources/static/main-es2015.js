...
let IstorijaComponent = class IstorijaComponent {
    constructor(service, datePipe, modalService, klinikaService, ljekarService) {
    ...
    ngOnInit() {
        this.service.preuzmiIstoriju().subscribe(data => {
            this.pregledi = data;
    ...
    ocijeniKliniku(template, pregled) {
    ...
    ocijeniLjekara(template, pregled) {
    ...
    ocijeniK() {
        this.modalRef.hide();
        this.klinikaService.ocijeniKliniku(this.ocjenjenaKlinika, this.klinikaZaOcjenu).subscribe(data => {
            this.service.preuzmiIstoriju().subscribe(data => {
                this.pregledi = data;
                for (let date of this.pregledi) {
                    date.medium = this.datePipe.transform(date.termin, "d MMM y, h:mm a");
    ...
    ocijeniLj() {
        this.modalRef.hide();
        this.ljekarService.ocijeniLjekara(this.ocjenjenLjekar, this.ljekarZaOcjenu).subscribe(data => {
            this.service.preuzmiIstoriju().subscribe(data => {
                this.pregledi = data;
                for (let date of this.pregledi) {
                    date.medium = this.datePipe.transform(date.termin, "d MMM y, h:mm a");
...
IstorijaComponent.ctorParameters = () => [
...
let KlinikaComponent = class KlinikaComponent {
    constructor(service, serviceKlinika, sortService) {
        this.service = service;
    ...
    ngOnInit() {
        this.serviceKlinika.preuzmiSveKlinike().subscribe(data => {
            this.klinike = data;
...
KlinikaComponent.ctorParameters = () => [
...
let PacijentComponent = class PacijentComponent {
    constructor(router, route, serviceOdjava) {
        this.router = router;
        this.route = route;
...
PacijentComponent.ctorParameters = () => [
...
let PocetnaPacijentComponent = class PocetnaPacijentComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PregledComponent = class PregledComponent {
    constructor(service, datePipe, toastr) {
        this.service = service;
        this.datePipe = datePipe;
        this.toastr = toastr;
        this.pregledi = [];
    ...
    ngOnInit() {
        this.service.preuzmiDostupnePreglede().subscribe(data => {
            this.pregledi = data;
            for (let date of this.pregledi) {
    ...
    zakaziDostupniPregled(pregled) {
        this.toastr.info("Molimo sacekajte, u toku je zakazivanje pregleda");
        this.service.zakaziDostupniPregled(pregled).subscribe(data => {
...
PregledComponent.ctorParameters = () => [
    { type: src_app_service_pregled_service__WEBPACK_IMPORTED_MODULE_2__["PregledService"] },
    { type: _angular_common__WEBPACK_IMPORTED_MODULE_3__["DatePipe"] },
...
let ProfilComponent = class ProfilComponent {
    constructor(router, route, service, toastr, modalService) {
        this.router = router;
        this.route = route;
        this.service = service;
        this.toastr = toastr;
    ...
    ngOnInit() {
        this.service.vratiTrenutnogKorisnika().subscribe(data => {
    ...
    izmijeniPodatke() {
        this.service.izmjenaPodataka(this.trenutniKorisnik).subscribe(data => {
            this.toastr.success("Uspjesno ste promijenili podatke!", this.trenutniKorisnik.ime);
        }, error => {
        });
    }
    izmijeniLozinku(template) {
        this.modalRef = this.modalService.show(template);
    }
    izmijeniLozinku2() {
        this.service.izmjenaLozinke(this.novaLozinka).subscribe(data => {
...
let ZakazaniPreglediComponent = class ZakazaniPreglediComponent {
    constructor(service, datePipe, toastr) {
        this.service = service;
        this.datePipe = datePipe;
        this.toastr = toastr;
    ...
    ngOnInit() {
        this.service.preuzmiZakazanePreglede().subscribe(data => {
            this.pregledi = data;
            for (let date of this.pregledi) {
                date.medium = this.datePipe.transform(date.termin, "MMM d, y");
            }
    ...
    otkaziPregled(pregled) {
        ...
        if ((this.otkazDatum.getTime() - this.danasnjiDatum.getTime()) < 86400000) {
            ...
            this.service.otkaziPregled(pregled).subscribe(data => {
...
ZakazaniPreglediComponent.ctorParameters = () => [
    { type: src_app_service_pregled_service__WEBPACK_IMPORTED_MODULE_2__["PregledService"] },
    { type: _angular_common__WEBPACK_IMPORTED_MODULE_3__["DatePipe"] },
    { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"] }
];
...
let ZakazivanjePregledaComponent = class ZakazivanjePregledaComponent {
    constructor(serviceKlinika, servicePregled, serviceLjekar, toastr, modalService, route, router) {
        this.serviceKlinika = serviceKlinika;
    ...
    ngOnInit() {
        this.servicePregled.preuzmiTipovePregleda().subscribe(data => {
    ...
    pretraziKlinike() {
        ...
        if (!this.validacija) {
            ...
            this.serviceKlinika.pretragaKlinika(this.pregled.ime, this.ocjenaKlinike, this.lokacijaKlinike).subscribe(data => {
                this.klinike = data.klinike;
                this.cijena = data.cijenaPregleda;
            });
        }
    }
    prikaziLjekare(klinika) {
        this.prikazTabeleLjekara = true;
        this.ljekari = klinika.ljekari;
        this.klinikaZaPregled = klinika;
    }
    prikaziTermine(template, ljekar) {
        this.modalRef = this.modalService.show(template);
    ...
    pretraziLjekare() {
        this.serviceLjekar.pretragaLjekara(this.imeLjekaraPretraga, this.prezimeLjekaraPretraga, this.ocjenaLjekara, this.ljekari).subscribe(data => {
            this.ljekari = data;
        });
    }
    zakaziPregled() {
        ...
        if (this.datumPregleda > this.ljekar.godisnji_od && this.datumPregleda < this.ljekar.godisnji_do) {
            ...
            this.toastr.info("Molimo sacekajte, u toku je zakazivanje pregleda");
            this.servicePregled.zakaziNoviPregled(this.zakazaniPregled).subscribe(data => {
                this.toastr.success("Uspjesno ste zakazali pregled");
            }, error => {
...
ZakazivanjePregledaComponent.ctorParameters = () => [
...
let ZdravstveniKartonComponent = class ZdravstveniKartonComponent {
...
ZdravstveniKartonComponent.ctorParameters = () => [
    { type: src_app_service_pregled_service__WEBPACK_IMPORTED_MODULE_2__["PregledService"] },
    { type: _angular_common__WEBPACK_IMPORTED_MODULE_3__["DatePipe"] }
];
...
let PocetnaStranicaComponent = class PocetnaStranicaComponent {
...
PocetnaStranicaComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
...
let PrijavaComponent = class PrijavaComponent {
    constructor(toastr, authService, router, route, userService, serviceOdjava) {
        this.toastr = toastr;
...
PrijavaComponent.ctorParameters = () => [
...
let RegistracijaComponent = class RegistracijaComponent {
    constructor(korisnikService, router, toastr, formBuilder) {
    ...
    registujSe() {
        ...
        if (!this.validacija) {
            ...
            this.korisnikService.registracija(this.korisnik).subscribe(data => {
...
RegistracijaComponent.ctorParameters = () => [
    { type: src_app_service_korisnik_service__WEBPACK_IMPORTED_MODULE_3__["KorisnikService"] },
...
let PacijentGuard = class PacijentGuard {
    constructor(authService, router) {
        this.authService = authService;
        this.router = router;
    }
...
let AuthService = class AuthService {
    ...
    login(user) {
        return this.http.post("api/login", { username: user.username, password: user.password })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(response => this.doLoginUser(response)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mapTo"])(true), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(error => {
...
let KlinikaService = class KlinikaService {
    constructor(http) {
        this.http = http;
    }
    preuzmiSveKlinike() {
...
let PregledService = class PregledService {
    constructor(http) {
        this.http = http;
    }
    preuzmiSvePreglede() {
